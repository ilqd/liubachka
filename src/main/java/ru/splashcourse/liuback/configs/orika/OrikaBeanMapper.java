package ru.splashcourse.liuback.configs.orika;
 ...
 * factory. To use it just autowire it into a class.
 *
 * @author dlizarra
 */
@Component
public class OrikaBeanMapper extends ConfigurableMapper implements ApplicationContextAware {
	...
	/**
	 * Scans the appliaction context and registers all Mappers and Converters found
	 * in it.
	 *
